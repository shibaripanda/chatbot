...
export const getUser = async (ctx, appContext) => {
    try{
        ...
        const obj = {_id: 1, id: 1, usernameCurrent: 1, countMessagesInChat: 1, love: 1, text: 1, photoForPresent: 1, time: 1, createdAt: 1, updatedAt: 1, statusName: 1, status: 1, loveStatus: 1}
